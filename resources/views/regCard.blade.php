  ...
  <div class="card-container">
    ...
    <div class="card shadow custom-card">
      <div class="card-body">
        ...
        <p class="card-text">SignUp for Companies.</p>
        <a href="/CompanyReg" class="btn btn-primary"> Companies SignUp</a>
      </div>
    </div>
    ...
    <div class="card shadow custom-card">
      <div class="card-body">
        ...
        <a href="/user/register" class="btn btn-primary">Users SignUp</a>
      </div>
    </div>
  </div>
