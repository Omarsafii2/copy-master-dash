...
<body>
    ...
    <div class="login-container">
        <div class="login-image">
            ...
            <p class="lead">Access your account and explore the latest job opportunities.</p>
        </div>
        ...
        <div class="login-form">
            ...
            <p class="text-center mt-2">
                ...
                <a href="/user/register" class="text-decoration-none text-primary fw-bold">Sign up</a>
            </p>
        </div>
    </div>
