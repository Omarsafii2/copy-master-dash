...
<body>
    <nav class="navbar navbar-expand-lg bg-dark sticky-navbar p-3 container-fluid">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold text-primary" href="/users/home"><img src="{{ asset('images/logo2.webp') }}" width="50" height="50" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-light active" aria-current="page" href="/users/home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/users/job">Jobs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/users/company">Companies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/users/about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/users/contact">Contact</a>
                    </li>
